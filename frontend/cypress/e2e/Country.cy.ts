describe("Run the country page on desktop", () => {
    ...
    it("Checks if all country information is correctly displayed", () => {
        ...
        cy.get('img[alt="Image of Norway"]')
            .should("be.visible")
            .and("have.attr", "src", "https://example.com/norway.jpg");
...
describe("Run the country page on mobile", () => {
    ...
    it("Checks if all country information is correctly displayed", () => {
        ...
        cy.get('img[alt="Image of Japan"]')
            .should("be.visible")
            .and("have.attr", "src", "https://example.com/japan.jpg");
