...
const JournalCard: React.FC<JournalCardProps> = ({ country, date, image }) => {
  ...
  const toggleModal = () => {
    if (!date) { // Only toggle the modal if there is no date (not journaled)
    ...
    <div className={styles.cardWrapper}>
        ...
        <div className={styles.cardText}>
            ...
            <div className={styles.modal} role="dialog" aria-modal="true" aria-labelledby="journalModalTitle">
                ...
                <textarea placeholder="Start writing..." className={styles.textArea} aria-label="Journal entry text area"></textarea>
